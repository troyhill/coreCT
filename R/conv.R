#' @title Convert a matrix of semi-processed DICOM images to mass and volume of material classes. This is a deprecated version.
#'
#' @description Converts raw CT units to material classes for each CT slice, directly replicating Earl Davey's manual classification approach. This method is deprecated as of coreCT version 1.3.0.
#'
